 ...
 * tracks the major of this package. Bumping the package to 2.x means creating
 * `doc/2/` and registering it, then bumping this constant.
 *
 ...
 */
const DOC_BASE = 'https://docs.kuzzle.io/official-plugins/eslint/1/rules';

/**
 * Builds the `meta.docs.url` of a rule from the module that defines it.
 *
 * `docUrl(import.meta)` in `lib/rules/no-then.ts` returns
 * `https://docs.kuzzle.io/official-plugins/eslint/1/rules/no-then/`.
 */
